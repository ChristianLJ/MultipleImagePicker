package com.ltaps.multipleimagepicker;
...
import com.ltaps.multipleimagepicker.ui.album.AlbumActivity;
    ...
    public static class BaseProperty implements BasePropertyImpl {
        ...
        public void startAlbum() {
            ...
            if (Define.ALBUM_THUMBNAIL_SIZE == -1)
                Define.ALBUM_THUMBNAIL_SIZE = (int) context.getResources().getDimension(R.dimen.album_thumbnail_size);
