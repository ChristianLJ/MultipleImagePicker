package com.ltaps.multipleimagepicker.adapter;
...
import com.ltaps.multipleimagepicker.R;
import com.ltaps.multipleimagepicker.bean.ImageBean;
import com.ltaps.multipleimagepicker.bean.PickedImageBean;
import com.ltaps.multipleimagepicker.define.Define;
import com.ltaps.multipleimagepicker.ui.picker.PickerController;
import com.ltaps.multipleimagepicker.util.SquareTextView;
...
public class PickerGridAdapter extends RecyclerView.Adapter<PickerGridAdapter.ViewHolder> {
    ...
    public PickerGridAdapter(ImageBean[] imageBeans, ArrayList<PickedImageBean> pickedImageBeans, PickerController pickerController, String saveDir) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.thum_item, parent, false);
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolderImage) {
            ...
            if (imgPath != null && !imgPath.equals("")) {
                Picasso.with(vh.imgPhoto.getContext())
            ...
            vh.imgPhoto.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (vh.txtPickCount.getVisibility() == View.GONE && Define.ALBUM_PICKER_COUNT > pickedImageBeans.size()) {
                        vh.txtPickCount.setVisibility(View.VISIBLE);
                        ...
                        if (Define.IS_AUTOMATIC_CLOSE && Define.ALBUM_PICKER_COUNT == pickedImageBeans.size()) {
