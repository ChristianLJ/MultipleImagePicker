package com.ltaps.multipleimagepicker.ui.album;
...
class AlbumController {
    ...
    private class LoadAlbumList extends AsyncTask<Void, Void, ArrayList<Album>> {
        ...
        protected ArrayList<Album> doInBackground(Void... params) {
            ...
            String[] projection = new String[]{MediaStore.Images.Media.BUCKET_DISPLAY_NAME, MediaStore.Images.Media.BUCKET_ID};

            Cursor imageCursor = resolver.query(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, projection, null, null, orderBy);
            ...
            if (imageCursor != null) {
                ...
                int bucketColumnId = imageCursor.getColumnIndex(MediaStore.Images.Media.BUCKET_ID);
