package com.ltaps.multipleimagepicker.ui.picker;
...
import com.ltaps.multipleimagepicker.adapter.PickerGridAdapter;
import com.ltaps.multipleimagepicker.bean.Album;
...
import com.ltaps.multipleimagepicker.permission.PermissionCheck;
import com.ltaps.multipleimagepicker.util.UiUtil;
...
public class PickerActivity extends AppCompatActivity {
    ...
    public void setAdapter(ImageBean[] result) {
        if (adapter == null)
            adapter = new PickerGridAdapter(result, pickedImageBeans, pickerController, pickerController.getPathDir(album.bucketId));
